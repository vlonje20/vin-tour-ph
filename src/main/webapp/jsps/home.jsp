...
<div class="w3-row-padding w3-bright">
        ...
        <div class="w3-container w3-padding-32" id="about">
            ...
            <p>On February 7, 1995, Bonifacio Land Corporation (BLC) started planning a major urban development—Bonifacio Global City. 
                BLC made a successful bid to become BCDA's partner in the development of the district. The Ayala Corporation through Ayala Land, Inc., 
                and Evergreen Holdings, Inc. of the Campos Group purchased a controlling stake in BLC from Metro Pacific in 2003. BCDA and 
                the two companies now control Fort Bonifacio Development Corporation, which oversees the master planning of Bonifacio Global City.
            </p>
        </div>
        ...
        <!-- Fillinvest Section -->
        <div class="w3-container w3-padding-32" id="Filinvest City">
            <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Filinvest City</h3>
            <p>It was all spurred by the vision of Filinvest Development Corporation founder Andrew L. Gotianun Sr.
               In 1995, the ambitious transformation of the underutilized Alabang Stock Farm into a fully-integrated,
               self-contained, and future-ready urban development began.
               Today, Filinvest City is the fulfillment of a promise to provide a masterplanned development - one that is 
               conducive to meeting global business demands, enriching the lives of those working in the city, catering to the 
               evolving lifestyle needs of its residents, and inspiring new generations to come - truly, a live-work-play community.
            </p>
        </div>
        ...
        <div class="w3-container w3-padding-32" id="Makati City">
            <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Makati City</h3>
            <p>Makati is the financial center of the Philippines; it has the highest concentration of multinational and local 
                corporations in the country. Major banks, corporations, department stores as well as foreign embassies are based in Makati. 
                The biggest trading floor of the Philippine Stock Exchange used to be situated along the city's Ayala Avenue, 
                before the stock exchange moved their headquarters to the Bonifacio Global City in Taguig. 
